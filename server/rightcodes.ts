import { coerceDetailLevelForModel } from '../src/modelDetailPolicy';
import type { DetailLevel, RightCodesModel } from '../src/types';
...
const RIGHTCODES_SIZE_MAP: Record<Exclude<SupportedAspectRatio, 'auto'>, string> = {
  '1:1': '1024x1024',
  '3:4': '1024x1536',
  '4:3': '1536x1024',
  '9:16': '1024x1536',
...
const DETAIL_LEVEL_MULTIPLIER: Record<DetailLevel, number> = {
  '1K': 1,
  '2K': 2,
  '4K': 4,
};

export function mapAspectRatioToRightCodesSize(
  aspectRatio: SupportedAspectRatio = '1:1',
  detailLevel: DetailLevel = '1K',
  model: RightCodesModel = 'gpt-image-2',
): string {
  if (aspectRatio === 'auto') {
    return 'auto';
  }
